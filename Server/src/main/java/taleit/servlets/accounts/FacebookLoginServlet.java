...
public class FacebookLoginServlet extends TaleitServlet{
    ...
    protected JSONObject handle(HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        SignUp signup = new SignUp(TaleItServer.Instance.getSafeModel(), username, Integer.toString((new SecureRandom()).nextInt()));
        ...
        Login login = new Login(TaleItServer.Instance.getSafeModel(), username);
